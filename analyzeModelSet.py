...
home = expanduser("~")
import csv
mcellExecutable = join(home, 'workspace', 'mcell', 'nbuild', 'mcell')
...
def generateData(testpath, databasename, repetitions, outputdir):
    ...
    mdlfiles = getFiles(testpath, 'mdl')
    mdlfiles = [x for x in mdlfiles if 'main' in x]
...
if __name__ == "__main__":
    ...
    generateData(namespace.test, databasename, namespace.repetitions, outputdir=namespace.workDirectory)
